...
/**
 * 自定义下拉刷新控件，可以记录最近更新的时间显示，使用SharedPreference记录时间
 * Created by llay on 2017/3/26.
 */
...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
    ...
    public RefreshableView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        header = LayoutInflater.from(context).inflate(R.layout.view_header_pull_to_refresh, null, true);
