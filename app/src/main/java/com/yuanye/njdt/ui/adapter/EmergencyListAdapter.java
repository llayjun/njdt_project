...
public class EmergencyListAdapter extends IBaseAdapter {

    public EmergencyListAdapter(Context mContext) {
        super(mContext);
    }
    ...
    protected IBaseViewHolder getViewHolder(View _view) {
        ...
        _viewHolder.mItemEmergencyCreater = _view.findViewById(R.id.item_emergency_creater);
    ...
    protected void updateView(IBaseViewHolder _holder, int _position) {
        ...
        String _creater = _emergencyListEntity.getUserName();
        ...
        if (!TextUtils.isEmpty(_creater)) {
            _viewHolder.mItemEmergencyCreater.setText(_creater);
        } else {
            _viewHolder.mItemEmergencyCreater.setText("");
        }
    ...
    public class ViewHolder implements IBaseViewHolder {
        ...
        private TextView mItemEmergencyCreater;
